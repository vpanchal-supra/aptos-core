...
pub const DEFAULT_FORGE_DEPLOYER_IMAGE_TAG: &str = "848265e5a7675c722ce9498f9520d1e92a89e2c0"; // default to the latest stable build from the main branch (2025-09-27)
